...
| Multi-page TFT build | Experimental | Limited to the recovered two-page layout and plain page1 controls, including image widgets that reference an existing picture ID. |
