    ...
    unfinished = [
        {
            ...
            "why_unfinished": [
                "fresh live evidence now proves both the official case52 page1 load oracle and the rebuilt local page1 load probe dispatch on corrected runtime page 0 for the minimal fixed 4-byte printh family",
                ...
                "broader general lifecycle equivalence is still unfinished: richer load bodies, loadend combinations, timers, and non-probe page-level logic are not yet established as a general recovered family"
            ],
            "blocks": [
        ...
        },
        {
            ...
            "status": "unfinished",
            "scope": "page1 file-browser authoring/save gap plus remaining page1 advanced-event expansion",
            "why_unfinished": [
                ...
                "without a saved page1 file-browser object, there is still no valid runtime or event-dispatch proof path for page1 file-browser itself",
            ],
            "blocks": [
                "page1 file-browser authoring/save recovery",
                "page1 file-browser runtime proof after authoring recovery",
