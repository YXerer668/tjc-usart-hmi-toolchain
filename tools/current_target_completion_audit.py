    ...
    unfinished = [
        {
            ...
            "why_unfinished": [
                ...
                "the new parity report shows the official oracle uses an inline page-load phase wrapper while the local build still emits a normal page event table, so the missing piece is still the recovered official page1 load wrapper or binding path rather than a trivial slot fill"
            ],
            "blocks": [
