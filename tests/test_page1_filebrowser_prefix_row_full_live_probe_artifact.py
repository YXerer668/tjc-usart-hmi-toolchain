...
ARTIFACT = Path("examples/lifecycle_runtime_smoke/page1_filebrowser_prefix_row_full_live_probe_2026-05-21.json")


class Page1FilebrowserPrefixRowFullLiveProbeArtifactTests(unittest.TestCase):
    def test_artifact_captures_full_row_patch_still_not_enumerating(self) -> None:
