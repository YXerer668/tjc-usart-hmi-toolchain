...
ARTIFACT = Path("examples/lifecycle_runtime_smoke/page1_filebrowser_prefix_rowhash_live_probe_2026-05-21.json")


class Page1FilebrowserPrefixRowhashLiveProbeArtifactTests(unittest.TestCase):
    def test_artifact_captures_rowhash_not_restoring_enumeration(self) -> None:
