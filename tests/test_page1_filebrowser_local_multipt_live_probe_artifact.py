...
ARTIFACT = Path("examples/lifecycle_runtime_smoke/page1_filebrowser_local_multipt_live_probe_2026-05-21.json")


class Page1FilebrowserLocalMultiPageLiveProbeArtifactTests(unittest.TestCase):
    def test_artifact_captures_current_local_builder_still_negative(self) -> None:
