...
ARTIFACT = Path("examples/lifecycle_runtime_smoke/page1_filebrowser_page_header_live_probe_2026-05-21.json")


class Page1FilebrowserPageHeaderLiveProbeArtifactTests(unittest.TestCase):
    def test_artifact_captures_page_header_patch_still_negative(self) -> None:
