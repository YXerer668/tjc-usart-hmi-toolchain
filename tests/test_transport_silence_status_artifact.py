...
class TransportSilenceStatusArtifactTests(unittest.TestCase):
    def test_artifact_summarizes_local_transport_dead_end(self) -> None:
        ...
        self.assertTrue(evidence["serial_break_pulse_probe"]["no_change_after_break"])
        ...
        self.assertTrue(evidence["sd_recovery_handoff"]["launcher_cmd"].endswith("00_总入口_先看我.cmd"))
        ...
        self.assertTrue(evidence["sd_recovery_handoff"]["zip_verified"])
        ...
        self.assertTrue(conclusions["usb_uart_bridge_itself_still_opens"])
        ...
        self.assertTrue(conclusions["serial_break_recovery_path_showed_no_change"])
        ...
        self.assertTrue(conclusions["external_sd_recovery_zip_is_ready"])
