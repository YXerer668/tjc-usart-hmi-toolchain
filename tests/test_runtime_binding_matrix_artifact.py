...
class RuntimeBindingMatrixArtifactTests(unittest.TestCase):
    def test_artifact_has_expected_shape(self) -> None:
        ...
        self.assertEqual(payload["summary"]["page1_advanced_binding_positive_count"], 2)
        self.assertFalse(payload["summary"]["page1_load_marker_recovered"])
        self.assertEqual(payload["summary"]["page1_remaining_controls_requiring_correct_page_recheck_count"], 3)
        self.assertEqual(
